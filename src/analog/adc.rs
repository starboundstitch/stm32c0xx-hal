...
impl Adc {
    ...
    ///
    /// Wait for tADCVREG_SETUP after calling [`Self::new()`] before calibrating, to wait for the
    ...
    pub fn read_vref(&mut self) -> u16 {
        ...
        let vref_cal: u32 = unsafe {
            // DS12766 3.14.2
            ptr::read_volatile(0x1FFF_756A as *const u16) as u32
        };
    ...
    pub fn read_temperature(&mut self) -> i16 {
        ...
        let ts_cal1: u32 = unsafe {
            ...
            ptr::read_volatile(0x1FFF_7568 as *const u16) as u32
        };
